...
public class CsvQuestionDaoTest {
    ...
    void shouldFindAllQuestions() {
        //given
        QuestionDao sut = new CsvQuestionDao(new AppProperties(TEST_QUESTIONS_FILE_NAME));
    ...
    void shouldReturnEmptyListOfQuestions() {
        //given
        QuestionDao sut = new CsvQuestionDao(new AppProperties(EMPTY_FILE_NAME));
    ...
    void shouldFailureIfFileIsNotExists() {
        //given
        QuestionDao sut = new CsvQuestionDao(new AppProperties("sagdsfg.csv"));
